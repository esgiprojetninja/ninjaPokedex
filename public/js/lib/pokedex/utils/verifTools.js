...
export const isEmpty = v => isUndefined(v) || ( isString(v) && v.length === 0 ) || ( isArray(v) && v.length === 0 );
...
export const objectHasProperties = (obj, props) => isObject(obj) && isUndefined( props.find( prop => !obj.hasOwnProperty(prop) ) );
